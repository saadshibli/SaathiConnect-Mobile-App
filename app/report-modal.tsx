...
//     setImageUri(uri);
//     setIsAnalyzing(true);
//     const predictedCategory = await analyzeImage(uri);
...
//       await handleImageSelected(res.assets[0].uri);
//   };
...
//       Alert.alert(
//         "Incomplete Report",
//         "Please fill all fields: photo, description, category, and location."
//       );
//       return;
//     }
...
//         // AI analysis meta for badge
//         formData.append(
//           "aiAnalyzed",
//           String(Boolean(!isModelLoading && !!imageUri))
//         );
//         if (category) formData.append("aiPredictedCategory", category);
//         formData.append("aiSource", "on-device");
